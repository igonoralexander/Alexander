...
class HowWeWorkManager extends Component
{
    use WithFileUploads;
    ...
    protected function rules()
    {
        return [
            ...
            'title' => 'nullable|string|max:50|unique:how_we_works,title,' . $this->selectedId,
    ...
    public function submit()
    {
        ...
        if ($this->selectedId) {
            ...
            $contents = HowWeWork::findOrFail($this->selectedId);
    ...
    {
        $content = HowWeWork::findOrFail($id);
    ...
    {
        $contents = HowWeWork::findOrFail($id);
        $contents->delete();
    ...
    {
        return view('livewire.how-we-work-manager');
    }
}
