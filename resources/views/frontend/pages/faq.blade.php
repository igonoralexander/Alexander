        ...
        <section class="flat-spacing-11">
            <div class="container">
                <div class="tf-accordion-wrap d-flex justify-content-between">
                    <div class="content">
                        <h2 class="mb_24">Frequently Asked Questions</h2>
                    ...
                    <div class="box tf-other-content radius-10 bg_grey-8">
                        ...
                        <div class="d-flex gap-20 align-items-center">
                            ...
                            <a href="https://wa.me/+2347069198779?text=Hello%20Alexander" target="_blank" rel="noopener noreferrer" aria-label="Chat with us on WhatsApp" class="tf-btn btn-line">Live chat<i class="icon icon-arrow1-top-left"></i></a>
                        </div>
                    </div>
                </div>
            </div>
