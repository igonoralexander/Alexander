            ...
            <div class="auto-container">
                <div class="featured-row">
                    <div class="sec-title centered" style = "margin-top: 60px; margin-bottom: 30px;">
                        ...
                        <p class="intro-text">Explore the diverse industries we empower with tailored solutions to drive innovation and growth.</p>
                    </div>
                            ...
                            <div class="feature-block-two col-lg-4 col-md-6 col-sm-12 wow fadeInUp" data-wow-delay="0ms">
                                <div class="inner-box" style="text-align: center; padding: 20px;">
                                    ...
                                    <div class="lower-content">
                                        <h3 style="font-weight: bold; font-size: 1.3em; margin-top: 10px;"><a href="{{ route('industries.details', $item->slug) }}">{{$item->name}}</a></h3>
                    ...
                    <div class="bottom-info" style = "margin-bottom: 50px;">
                        <div class="link-box" style="text-align: center;">
                            <a href="/industries" class="theme-btn btn-style-five">
