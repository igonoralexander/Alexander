            ...
            <div class="px_15 lg-px_40">
                <div class="global-reset tf-top-bar_wrap grid-3 gap-30 align-items-center">
                    <ul class="tf-top-bar_item tf-social-icon d-flex gap-10">
                        <li><a href="{{ $contact->linkedin }}" target="_blank" rel="noopener noreferrer" class="box-icon w_28 round social-linkedin bg_line"><i class="fab fa-linkedin fs-14"></i></a></li>
                        <li><a href="{{ $contact->github }}" target="_blank" rel="noopener noreferrer" class="box-icon w_28 round social-github bg_line"><i class="fab fa-github fs-14"></i></a></li>
                    </ul>
