          ...
          <div class="page-inner">
            <div class="page-header">
              ...
              <ul class="breadcrumbs mb-3">
                ...
                <li class="separator"><i class="icon-arrow-right"></i></li> 
                <li class="nav-item"><a href="#">Privacy Policy Page</a></li>
              </ul>
            </div>
            <div class="row">
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.privacy-policy.update', $PrivacyPolicy->id) }}" method = "POST">
                            ...
                            <div class="form-group">
                                ...
                                <textarea id = "content-editor" class="form-control" rows = "50">{{ old('content', $PrivacyPolicy->content) }}</textarea>
                                <input type="hidden" name="content" id="content">
                                @error('content') <span class="text-danger">{{ $message }}</span> @enderror
                            </div>

                            <button type = "submit" class="btn btn-primary"> Update </button>
                            <a href = "{{ route('admin.privacy-policy') }}" class="btn btn-secondary">Back </a>
                        </form>
                    </div>
                </div>
