            ...
            <div class="row">
                ...
                <div class="card mb-4">
                    <div class="card-header">
                        <h4> Add How We Work Page</h4>
                    </div>
                    <div class="card-body">
                        <form action="{{ route('admin.how-we-work.store') }}" method = "POST">
                            @csrf
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="main_title" value = "{{ old('main_title') }}" class="form-control" id="main_title" />
