                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.about-us.store') }}" method = "POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type = "text" name="founder" value = "{{ old('founder') }}"  class="form-control" id="founder" />
                                @error('founder') <span class="text-danger">{{ $message }}</span> @enderror
                            </div>

                            <div class="form-group">
                                <label for="content-editor">Who We Are</label>
                                <textarea id = "content-editor" class="form-control" rows = "50">{{ old('who_we_are') }}</textarea>
